...
public class HousingDataset {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread thread1 = new Thread(() -> {
            ...
            System.out.println("Highest Price Chas: " + dPO.getHighest());
            System.out.println("Lowest Price Chas: " + dPO.getLowest());
            System.out.println("Average Price Chas: " + dPO.getAverage());
        });
        ...
        Thread thread2 = new Thread(() -> {
            ...
            Statistics dPO1 = new Statistics(
                    ...
                    TopTen.stream().mapToDouble(HousingDataset::getMedv).average()
                            .orElse(Double.NaN));
            ...
            Statistics dPO2 = new Statistics(
                    ...
                    TopTen.stream().mapToDouble(HousingDataset::getNox).average()
                            .orElse(Double.NaN));
            ...
            Statistics dPO3 = new Statistics(
                    ...
                    TopTen.stream().mapToDouble(HousingDataset::getRm).average()
                            .orElse(Double.NaN));
        ...
        Thread thread3 = new Thread(() -> {
            ...
            Statistics dPO4 = new Statistics(
                    ...
                    hDLSP.stream().mapToDouble(HousingDataset::getMedv).average()
                            .orElse(Double.NaN));
        ...
        Thread thread4 = new Thread(() -> {
            ...
            Statistics dPO5 = new Statistics(
                    ...
                    hDLTax.stream().mapToDouble(HousingDataset::getMedv).average()
                            .orElse(Double.NaN));
